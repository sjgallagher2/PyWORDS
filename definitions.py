...
endings_list = ['', 'a', 'abam', 'abamini', 'abamur', 'abamus', 'abant', 'abantur', 'abar', 'abare', 'abaris', 
        ...
        'abitis', 'abitur', 'abo', 'abor', 'abunt', 'abuntur', 'abus', 'ac', 'ad', 'ae', 'aec', 'ai', 'am', 'amini', 
        'amur', 'amus', 'an', 'anc', 'anda', 'andae', 'andam', 'andarum', 'andas', 'ande', 'andi', 'andis', 'ando', 
        'andorum', 'andos', 'andum', 'andus', 'ans', 'ant', 'ante', 'antem', 'antes', 'anti', 'antia', 'antibus', 
        'antis', 'antium', 'anto', 'antor', 'antum', 'antur', 'ar', 'are', 'arem', 'aremini', 'aremur', 'aremus', 
        'arent', 'arentur', 'arer', 'arere', 'areris', 'ares', 'aret', 'aretis', 'aretur', 'ari', 'arier', 'aris', 
        'arum', 'arun', 'as', 'at', 'ate', 'atis', 'ato', 'ator', 'atote', 'atur', 'bam', 'bamini', 'bamur', 
        'bamus', 'bant', 'bantur', 'bar', 'bare', 'baris', 'bas', 'bat', 'batis', 'batur', 'bere', 'beris', 'berit', 
        'bimini', 'bimur', 'bimus', 'bis', 'bit', 'bitis', 'bitur', 'bo', 'bor', 'bunt', 'buntur', 'd', 'e', 'eam', 
        'eamini', 'eamur', 'eamus', 'eant', 'eantur', 'ear', 'eare', 'earis', 'eas', 'eat', 'eatis', 'eatur', 'ebam', 
        'ebamini', 'ebamur', 'ebamus', 'ebant', 'ebantur', 'ebar', 'ebare', 'ebaris', 'ebas', 'ebat', 'ebatis', 
        'ebatur', 'ebere', 'eberis', 'ebimini', 'ebimur', 'ebimus', 'ebis', 'ebit', 'ebitis', 'ebitur', 'ebo', 
        'ebor', 'ebunt', 'ebuntur', 'ebus', 'ed', 'ei', 'eis', 'em', 'eme', 'emini', 'emur', 'emus', 'en', 'enda', 
        'endae', 'endam', 'endarum', 'endas', 'ende', 'endi', 'endis', 'endo', 'endorum', 'endos', 'endum', 'endus', 
        'ens', 'ent', 'ente', 'entem', 'entes', 'enti', 'entia', 'entibus', 'entis', 'entium', 'ento', 'entor', 
        'entum', 'entur', 'enus', 'eo', 'eor', 'er', 'eram', 'eramus', 'erant', 'eras', 'erat', 'eratis', 'ere', 
        'erem', 'eremini', 'eremur', 'eremus', 'erent', 'erentur', 'erer', 'erere', 'ereris', 'eres', 'eret', 
        'eretis', 'eretur', 'eri', 'erier', 'erim', 'erimus', 'erint', 'eris', 'erit', 'eritis', 'ero', 'erum', 
        'erunt', 'es', 'ese', 'esse', 'essem', 'essemus', 'essent', 'esses', 'esset', 'essetis', 'est', 'este', 
        'estis', 'esto', 'estote', 'et', 'ete', 'etis', 'eto', 'etor', 'etote', 'etur', 'eu', 'fore', 'forem', 
        'foremus', 'forent', 'fores', 'foret', 'foretis', 'i', 'ia', 'iant', 'ias', 'iat', 'ibam', 'ibamus', 
        'ibant', 'ibas', 'ibat', 'ibatis', 'ibe', 'ibei', 'ibi', 'ibus', 'ic', 'id', 'iens', 'ier', 'iere', 'ieri', 
        'ies', 'ihi', 'ii', 'iis', 'im', 'imini', 'imur', 'imus', 'in', 'int', 'ire', 'irem', 'iremini', 'iremur', 
        'iremus', 'irent', 'irentur', 'irer', 'irere', 'ireris', 'ires', 'iret', 'iretis', 'iretur', 'iri', 
        'irier', 'iris', 'is', 'isse', 'issem', 'issemus', 'issent', 'isses', 'isset', 'issetis', 'isti', 'istis', 
        'it', 'ite', 'itis', 'ito', 'itor', 'itote', 'itur', 'ium', 'ius', 'jus', 'le', 'lem', 'lemus', 'lent', 
        'les', 'let', 'letis', 'ma', 'mae', 'mam', 'marum', 'mas', 'me', 'mi', 'mini', 'mis', 'mo', 'morum', 'mos', 
        'mum', 'mur', 'mus', 'o', 'obis', 'obus', 'oc', 'od', 'oe', 'om', 'on', 'or', 'ora', 'ore', 'orem', 'ores', 
        'ori', 'oribus', 'oris', 'orum', 'orun', 'os', 're', 'rem', 'remini', 'remur', 'remus', 'rent', 'rentur', 
        'rer', 'rere', 'reris', 'res', 'ret', 'retis', 'retur', 'ri', 'rier', 'ris', 's', 'se', 'sem', 'semus', 
        'sent', 'ses', 'set', 'setis', 'setur', 't', 'te', 'tis', 'to', 'tor', 'tote', 'tur', 'u', 'ua', 'ubus', 
        'uc', 'ud', 'ui', 'um', 'um', 'umus', 'un', 'unc', 'unda', 'undae', 'undam', 'undarum', 'undas', 'unde', 
        ...
        'ure', 'uri', 'uris', 'uro', 'urorum', 'uros', 'urum', 'urus', 'us', 'ut', 'uum', 'uus', 'yn', 'yos']
